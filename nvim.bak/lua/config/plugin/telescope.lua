local _2afile_2a = "nvim/fnl/config/plugin/telescope.fnl"
...
telescope.setup({defaults = {file_ignore_patterns = {"node_modules"}}, extensions = {file_browser = {hidden = true, hijack_netrw = true}, env = {}, heading = {treesitter = true}, ["ui-select"] = {themes.get_dropdown({})}, tele_tabby = {use_highlighter = false}, packer = {}, project = {sync_with_nvim_tree = true}}, pickers = {find_files = {find_command = {"rg", "--files", "--iglob", "!.git"}}}})
